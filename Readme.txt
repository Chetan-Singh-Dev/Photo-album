...
3.Extract the project file (photo-album) or (the name of the folder that you made ) in it.
4.Go to your browser and paste this link -> http://localhost/photo-album/ and hit enter.
Note:
Please save the folder with the name of photo-album and download all this files in this folder.
